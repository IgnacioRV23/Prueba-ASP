        ...
        <div class="row justify-content-center w-100 mt-3">
            <div class="col-3">
                <div class="p-4 rounded-3 bg-light shadow">
                    ...
                    <asp:TextBox runat="server" ID="txtDescripcion" placeholder="Descripcion" class="form-control mb-2" required="true" />
                    <asp:TextBox runat="server" ID="txtPrecio" placeholder="Precio" class="form-control mb-2" required="true" TextMode="Number" />
                    <asp:TextBox runat="server" ID="txtSaldo" placeholder="Saldo" class="form-control mb-2" required="true" TextMode="Number" />
                    <asp:TextBox runat="server" TextMode="DateTimeLocal" ID="txtFecha" placeholder="Fecha" class="form-control mb-2" required="true" />
                    <asp:TextBox runat="server" ID="txtUsuario" placeholder="Usuario" class="form-control mb-2" required="true" />
                    <asp:TextBox runat="server" ID="txtFamilia" placeholder="Familia" class="form-control mb-2" required="true" />
                    <div class="mb-2">
                        <asp:Label Text="ID Familia" runat="server" CssClass="form-label" />

                        <asp:DropDownList runat="server" ID="dropFamilia" CssClass="form-select">
                        </asp:DropDownList>
                    </div>
